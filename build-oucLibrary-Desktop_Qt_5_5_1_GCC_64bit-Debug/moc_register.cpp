...
QT_MOC_LITERAL(1, 9, 16), // "register_success"
...
QT_MOC_LITERAL(5, 45, 5) // "check"
    ...
    "Register\0register_success\0\0username\0"
    "password\0check"
};
...
void Register::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->register_success((*reinterpret_cast< QString(*)>(_a[1])),(*reinterpret_cast< QString(*)>(_a[2]))); break;
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Register::register_success)) {
                *result = 0;
            }
        }
    }
...
// SIGNAL 0
void Register::register_success(QString _t1, QString _t2)
{
