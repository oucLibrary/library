...
#include "../oucLibrary/PageWidget.h"
...
QT_MOC_LITERAL(1, 11, 18), // "currentPageChanged"
QT_MOC_LITERAL(2, 30, 0), // ""
QT_MOC_LITERAL(3, 31, 4) // "page"

    },
    "PageWidget\0currentPageChanged\0\0page"
};
...
void PageWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (PageWidget::*_t)(int );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&PageWidget::currentPageChanged)) {
                *result = 0;
            }
        }
    }
...
const QMetaObject PageWidget::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_PageWidget.data,
      qt_meta_data_PageWidget,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
