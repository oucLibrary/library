...
PageWidget::PageWidget(PageWidget &pagewidget) : ui(pagewidget.ui), blockSize(pagewidget.blockSize),
    maxPage(pagewidget.maxPage), currentPage(pagewidget.currentPage), pageLabels(pagewidget.pageLabels)
{
}
